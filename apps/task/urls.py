...
urlpatterns = [
    ...
    path('day/detail/<int:day_id>/task/detail/<int:pk>/', TaskRUDAPIView.as_view(), name='task_detail'),

    # time
    path('time/create/', TimeCreateAPIView.as_view()),
    path('day/detail/<int:day_id>/time/total/', TimeTotalAPIView.as_view(), name='day-total-time'),
]